...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /********** Begin Fingerprint Auth init code **********/
        ...
        /********** END Fingerprint Auth init code **********/

        initGigya();
    }

    public void initGigya() {
        GSAPI.getInstance().initialize(this, "3_1R2_kUKDiyugLtegTKAW6kF9Ug556FsJaPLJHy_wLWGft_xqSn2Sqg8OPAzKTfDD", "au1.gigya.com");
        ...
        GSAPI.getInstance().setAccountsEventListener(new GSAccountsEventListener() {
            ...
            public void onLogin(GSObject user, Object context) {
                ...
                currentUser = user;
                doFingerprintAuth(defaultCipher, DEFAULT_KEY_NAME);
            }
    ...
    public void onLogoutUser() {
        ...
        findViewById(R.id.loggedIn_message).setVisibility(View.GONE);
    }

    public void onLoggedUser() {
        try {
            // This is for demo purpose
            TextView v = findViewById(R.id.loggedIn_message);
            v.setText(currentUser.getString("UID"));

            // This is for demo purpose - User is granted access to app here
            findViewById(R.id.confirmation_message).setVisibility(View.VISIBLE);
            findViewById(R.id.loggedIn_message).setVisibility(View.VISIBLE);
    ...
    public void doFingerprintAuth(Cipher mCipher, String mKeyName) {
        /********** Fingerprint Auth capture code **********/
        ...
        /********** END Fingerprint Auth capture code **********/
    }
    ...
    private void showConfirmation(byte[] encrypted) {
        if(currentUser == null) {
            ...
            GSAPI.getInstance().sendRequest("accounts.getAccountInfo", null, resListener, null );
        } else {
            onLoggedUser();
        }
    }
